...
public class Common {
	...
	public static final String DEFAILT_DATE_FORMAT = "yyyy-MM-dd";
...
//	public static final String QUERIES_LOG = "queries.log";
	...
	public static final SimpleDateFormat defaultDateFormat = new SimpleDateFormat(Common.DEFAILT_DATE_FORMAT);
